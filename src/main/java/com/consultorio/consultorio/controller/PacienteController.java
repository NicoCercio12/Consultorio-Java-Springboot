...
public class PacienteController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<?> modificarPacientePorId(@RequestBody PacienteRequestDTO dtoPaciente, @PathVariable Long id){
        pacienteService.modificarPacientePorId(dtoPaciente, id);
